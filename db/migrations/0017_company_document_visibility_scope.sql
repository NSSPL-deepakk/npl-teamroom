ALTER TABLE public.company_documents
  ADD COLUMN IF NOT EXISTS visibility text NOT NULL DEFAULT 'ALL'
    CHECK (visibility IN ('ALL', 'MANAGER_ONLY', 'SELECTED_EMPLOYEES')),
  ADD COLUMN IF NOT EXISTS visible_employee_ids uuid[] NOT NULL DEFAULT '{}';
--> statement-breakpoint

UPDATE public.company_documents
SET visibility = CASE WHEN is_visible_to_all THEN 'ALL' ELSE 'MANAGER_ONLY' END
WHERE visibility = 'ALL' AND NOT is_visible_to_all;
--> statement-breakpoint
